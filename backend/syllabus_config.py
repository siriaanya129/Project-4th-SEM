...
SYLLABUS_TOPICS = {
    ...
    "Types of sampling": {
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": None, "bloom": "Remember", "difficulty_rating": 3,
    ...
    "Sample Mean (Sampling Distribution Context)": {
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": "Types of sampling", "bloom": "Understand", "difficulty_rating": 4,
    ...
    "Sample Variance (Sampling Distribution Context)": {
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": "Sample Mean (Sampling Distribution Context)", "bloom": "Understand", "difficulty_rating": 4,
    ...
    "Sampling distributions from a normal population": {
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": "Sample Variance (Sampling Distribution Context)", "bloom": "Apply", "difficulty_rating": 6,
        "sub_topics": ["Distribution of sample mean when population is normal", "Properties of this sampling distribution"]
    },
     "Sampling from a finite population": {
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": "Types of sampling", "bloom": "Apply", "difficulty_rating": 5,
    ...
    "Normal Distribution (Properties and Applications)": { 
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": "Describing data sets - Grouped data, histograms", 
    ...
    "Binomial Distribution": { 
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": None, "bloom": "Apply", "difficulty_rating": 6,
    ...
    "Approximating binomial, Poisson distributions using normal distribution": {
        "unit_name": "Unit-II Sampling and Sampling Distributions", "parent": "Normal Distribution (Properties and Applications)", "bloom": "Apply", "difficulty_rating": 7,
    ...
    "Covariance": {
        "unit_name": "Unit-III Correlation, Covariance and Independent Random Variables", "parent": "Joint behavior of random variables", "bloom": "Apply", "difficulty_rating": 6,
        "sub_topics": ["Covariance calculation (from data/summary stats)", "Covariance interpretation (sign, magnitude)", "Relationship between covariance and correlation", "Cov(X,Y) for independent variables"]
    },
    ...
    "Types of Estimators (Properties)": { 
    ...
    "Large sample confidence interval for a population proportion": {
        ...
        "sub_topics": ["CI formula for proportion", "Conditions for validity (np > 5, n(1-p) > 5)"]
    },
    ...
    "Testing of hypothesis about population parameters": { 
...
def get_unit_names() -> list:
    """Returns a list of unique unit names from the syllabus, maintaining an order."""
    # Order of units as they appear in the syllabus image
    ordered_unit_names = [
        "Unit-I Descriptive Statistics",
        "Unit-II Sampling and Sampling Distributions",
        "Unit-III Correlation, Covariance and Independent Random Variables",
    ...
    # Verify all defined unit names are in our ordered list (optional sanity check)
    # present_units = set()
    # for topic_details in SYLLABUS_TOPICS.values():
    #     present_units.add(topic_details["unit_name"])
    # if not present_units.issubset(set(ordered_unit_names)):
    #     print("Warning: Some unit names in SYLLABUS_TOPICS are not in the predefined order for get_unit_names()")
    return ordered_unit_names